...
local function CreateCastBarSettings(parentContainer)
    ...
    local borderSizeSlider = AG:Create("Slider")
    borderSizeSlider:SetLabel("Border Size")
    borderSizeSlider:SetValue(BCDM.db.profile.CastBar.BorderSize)
    borderSizeSlider:SetSliderValues(0, 3, 1)
    borderSizeSlider:SetCallback("OnValueChanged", function(_, _, value) BCDM.db.profile.CastBar.BorderSize = value BCDM:UpdateBCDM() end)
    borderSizeSlider:SetRelativeWidth(0.25)
    toggleContainer:AddChild(borderSizeSlider)
