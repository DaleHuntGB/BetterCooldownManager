...
local function CreateGlobalSettings(parentContainer)
    ...
    enableCDMSkinningCheckbox:SetRelativeWidth(0.5)
    ...
    disableAuraOverlayCheckbox:SetCallback("OnEnter", function()
        ...
        GameTooltip:AddLine("This will remove the |cFFFFFF40yellow|r overlay that |cFF00AEF7Blizzard|r applies but will ruin |cFFCCCCCCdesaturation|r effects.", 1, 1, 1, false)
        GameTooltip:Show()
    end)
    disableAuraOverlayCheckbox:SetCallback("OnLeave", function() GameTooltip:Hide() end)
    disableAuraOverlayCheckbox:SetRelativeWidth(0.5)
