...
function BCDM:CreateSecondaryPowerBar()
    ...
    secondaryPowerBar.Text:SetFont(BCDM:ResolveElementFont(secondaryPowerBarDB.Text.Font), secondaryPowerBarDB.Text.FontSize, secondaryPowerBarDB.Text.FontFlag or generalDB.Fonts.FontFlag)
